...
class _GradeState extends State<Gradem20> {
  static String mxRatio20 = "1:1.5:3";
  static String mxGrade20 = "M20";
  static String mxStrength ="20Mpa";
  String appBarText ='$mxGrade20 Grade $mxRatio20';
  ...
  String infoText4 =
      "\n\nIn the below calculator increase the unit count for cement and get the unit count for sand and aggregate below to form a $mxGrade20 grade concrete.";
  String applicationsInfo =
      "\nIt is used in construction/casting of slabs, beams, columns, footings (for mild exposure).";
  String notes =
      "$mxGrade20 is the minimum grade of concrete to be used in RCC, as recommended by IS 456. It can be used for construction of any RCC structure not exposed to severely degrading environments and extreme loads.";
  var mxArr = [1.5, 3];
