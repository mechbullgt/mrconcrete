...
class Gradem15 extends StatefulWidget {
  static const String routeName = "/15";
  
  @override
  _GradeState createState() => new _GradeState();
}

class _GradeState extends State<Gradem15> {
  static String mxRatio15 = "1:2:4";
  static String mxGrade15 = "M15";
  String appBarText ='$mxGrade15 Grade $mxRatio15';

  String infoText1 = 'Grade M15 Concrete is with ingredients ratio as ';
  String infoText2bold =
      "1:2:4 (1 unit cement, 2 unit sand, 4 unit aggregate).";
  String infoText3 =
      "\nIts called so because with the $mxGrade15 grade concrete a strength of 15MPa can be achieved with a curing of 28 days.";
  String infoText4 =
      "\n\nIn the below calculator increase the unit count for cement and get the unit count for sand and aggregate below to form a $mxGrade15 grade concrete.";
  ...
  String notes =
      "$mxGrade15 is mostly used in PCC (Plain Cement Concrete).";
  var mxArr = [2.0, 4];
