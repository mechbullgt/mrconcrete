...
class Mortar105 extends StatefulWidget {
  static const String routeName = "/105";
  
  @override
  _GradeState createState() => new _GradeState();
}

class _GradeState extends State<Mortar105> {
  static String mxRatio45 = "1:3";
  String appBarText ='Beam/Column Plastering';
  _GradeState(){
  print("AppBarText:"+appBarText);
  }
  String infoText1 = 'A mortar mix of ratio $mxRatio45, 1 unit of cement to 3 unit of sand is required for plastering the beams and columns.';
  String infoText4 =
