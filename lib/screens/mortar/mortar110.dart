...
class Mortar110 extends StatefulWidget {
  static const String routeName = "/110";
  
  @override
  _GradeState createState() => new _GradeState();
}

class _GradeState extends State<Mortar110> {
  static String mxRatio45 = "1:4";
  String appBarText ='Exterior Wall Plastering';
  _GradeState(){
  print("AppBarText:"+appBarText);
  }
  String infoText1 = 'A mortar mix of ratio $mxRatio45, 1 unit of cement to 4 unit of sand is required for plastering the exterior walls.';
  String infoText4 =
