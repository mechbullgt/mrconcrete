...
class Mortar100 extends StatefulWidget {
  static const String routeName = "/100";
  
  @override
  _GradeState createState() => new _GradeState();
}

class _GradeState extends State<Mortar100> {
  static String mxRatio45 = "1:4";
  String appBarText ='Ceiling Plastering';
  _GradeState(){
  print("AppBarText:"+appBarText);
  }
  String infoText1 = 'A mortar mix of ratio $mxRatio45, 1 unit of cement to 4 unit of sand is required for plastering the ceiling.';
  String infoText4 =
