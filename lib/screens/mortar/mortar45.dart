...
class Mortar45 extends StatefulWidget {
  static const String routeName = "/45";
  
  @override
  _GradeState createState() => new _GradeState();
}

class _GradeState extends State<Mortar45> {
  static String mxRatio45 = "1:4";
  static String mxWallThickness="4.5";
  String appBarText ='Brickwork 4.5" Wall';
  _GradeState(){
  print("AppBarText:"+appBarText);
  }
  String infoText1 = 'A mortar mix of ratio $mxRatio45, 1 unit of cement to 4 unit of sand is required for the brickwork of a $mxWallThickness thick wall.';
  String infoText4 =
