...
class Mortar115 extends StatefulWidget {
  static const String routeName = "/115";
  
  @override
  _GradeState createState() => new _GradeState();
}

class _GradeState extends State<Mortar115> {
  static String mxRatio45 = "1:3";
  String appBarText ='Exterior Wall Plastering';
  _GradeState(){
  print("AppBarText:"+appBarText);
  }
  String infoText1 = 'A mortar mix of ratio $mxRatio45, 1 unit of cement to 3 unit of sand is required for any kind of repair works.';
  String infoText4 =
