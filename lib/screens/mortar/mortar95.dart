...
class Mortar95 extends StatefulWidget {
  static const String routeName = "/95";
  
  @override
  _GradeState createState() => new _GradeState();
}

class _GradeState extends State<Mortar95> {
  static String mxRatio45 = "1:6";
  String appBarText ='Interior Wall Plastering';
  _GradeState(){
  print("AppBarText:"+appBarText);
  }
  String infoText1 = 'A mortar mix of ratio $mxRatio45, 1 unit of cement to 6 unit of sand is required for plastering interior walls.';
  String infoText4 =
